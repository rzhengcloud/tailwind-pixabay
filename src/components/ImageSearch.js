    ...
    return (
        <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
          <form onSubmit = {onSubmit} className="w-full max-w-sm">
            ...
            <button className="flex-shrink-0 bg-blue-500 hover:bg-teal-700 border-teal-500 hover:border-red-700 text-sm border-4 text-black py-1 px-2 rounded" type="submit">
          Search
          </button>
          </div>
          </form>
